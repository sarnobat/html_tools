...
# 	Ubuntu:
#
#		zsh ~/computers.git/mac/bin/find_dirs_first.sh  ~/sarnobat.git/vhs/  | tee /tmp/files.txt | bash file2img_recursive.sh | tee /tmp/files2.txt | sh file2img_html.sh 2>/dev/null
# 	Mac:
#
